            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="appointment.php">Place Order</a></li>
                ...
                <div class="footer-section">
                    <h4>Categories</h4>
                    <ul>
                        <li><a href="products.php">Skincare</a></li>
                        <li><a href="products.php">Makeup</a></li>
                        <li><a href="products.php">Hair Care</a></li>
                        <li><a href="products.php">Body Care</a></li>
                        <li><a href="products.php">Fragrances</a></li>
                    </ul>
                </div>
